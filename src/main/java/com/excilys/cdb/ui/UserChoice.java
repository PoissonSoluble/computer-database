...
enum UserChoice {
    LIST_COMPUTERS("1/ List computers", new ComputerLister(), "1", "list computers"), LIST_COMPANIES(
            "2/ List companies", new CompanyLister(), "2", "list companies"), DETAIL_COMPUTER("3/ Detail computer",
                    new ComputerItemizer(), "3", "detail computer"), CREATE_COMPUTER("4/ Create computer",
                            new ComputerCreator(), "4", "create computer"), UPDATE_COMPUTER("5/ Update computer",
                                    new ComputerModifier(), "5",
                                    "update computer"), REMOVE_COMPUTER("6/ Remove computer", new ComputerRemover(),
                                            "6", "remove computer"), EXIT("7/ Exit", null, "7", "exit");
