...
enum UserChoice {
	...
	UPDATE_COMPUTER("5/ Update computer",new ComputerLister(),"5","update computer"),
	REMOVE_COMPUTER("6/ Remove computer",new ComputerLister(),"6","remove computer"),
	EXIT("7/ Exit",null,"7","exit");
	
	private List<String> validChoices;
	private String title;
	private CLIActionHandler handler;
	private UserChoice(String pTitle, CLIActionHandler pHandler, String ... pValidChoices) {
		title = pTitle;
		handler = pHandler;
